...
class Aplicacion:
    ...
    def framecopia(self):
        ...
        self.entrada1.grid(column=1,row=0,padx=5,pady=5,sticky="e")

        self.label2 = ttk.Label(self.labelframe1,text="Desde columna: ")
        self.label2.grid(column=0,row=1,padx=5,pady=5,sticky="e")

        self.dato2 = tk.StringVar()
        self.entrada2 = ttk.Entry(self.labelframe1,textvariable=self.dato2)
        self.entrada2.grid(column=1,row=1,padx=5,pady=5,sticky="e")
        ...
        self.entrada3 = ttk.Entry(self.labelframe1,textvariable=self.dato3)
        self.entrada3.grid(column=1,row=2,padx=5,pady=5,sticky="e")
        ...
        self.entrada4 = ttk.Entry(self.labelframe1,textvariable=self.dato4)
        self.entrada4.grid(column=1,row=3,padx=5,pady=5,sticky="e")
