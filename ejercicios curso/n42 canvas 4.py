...
class Aplicacion:
    ...
    def entradadatos(self):
        ...
        self.entrada1 = ttk.Entry(self.lf1,textvariable=self.dato1)
        ...
        self.entrada2 = ttk.Entry(self.lf1,textvariable=self.dato2)
        ...
        self.entrada3 = ttk.Entry(self.lf1,textvariable=self.dato3)
        self.entrada3.grid(column=1,row=2,padx=5,pady=5)

        self.boton1 = ttk.Button(self.lf1,text="Generar grafico",command=self.grafico_barraporcentual)
