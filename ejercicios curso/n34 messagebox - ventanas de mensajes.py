...
class Aplicacion:
    def __init__(self):
        self.ventana1 = tk.Tk()
        self.labelframe1 = tk.LabelFrame(self.ventana1,text="Suma de numeros")
    ...
    def agregar_componentes(self):
        self.label1 = ttk.Label(self.labelframe1,text="Ingresa primer valor: ")
    ...
    def agregar_menu(self):
        ...
        self.ventana1.configure(menu=self.menubar1)
    ...
    def sumar(self):
        if self.dato1.get() == "" or self.dato2.get()=="":
            mb.showerror("Cuidado","No se puede dejar los cuadros de entrada de numenos vacios")
        else:
